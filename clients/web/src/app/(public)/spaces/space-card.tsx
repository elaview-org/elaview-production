...
export const PublicSpacesSpaceCard_SpaceFragment = graphql(`
  fragment PublicSpacesSpaceCard_SpaceFragment on Space {
    id
    title
    description
    city
...
type Props = {
  data: FragmentType<typeof PublicSpacesSpaceCard_SpaceFragment>;
};

export default function SpaceCard({ data }: Props) {
  const space = getFragmentData(PublicSpacesSpaceCard_SpaceFragment, data);
