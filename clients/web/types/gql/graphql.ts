...
export type DashboardUserQuery = { me: { __typename: 'User', id: unknown, email: string, name: string, avatar: string | null, role: UserRole, activeProfileType: ProfileType } | null };
