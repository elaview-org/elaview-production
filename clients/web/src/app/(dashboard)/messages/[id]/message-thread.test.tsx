...
import { ErrorState, MessageThread } from "./message-thread";
import type { Message, ThreadContext } from "@/types/messages";
import {
  mockMessages,
  mockThreadContext,
} from "@/app/(dashboard)/messages/mock-data";
import React from "react";

// Mock next/link BEFORE importing components that use it
...
describe.skip("MessageThread", () => {
  ...
  describe("Loading State", () => {
    it("shows loading skeleton when isLoading is true", () => {
      ...
      // Should show skeleton elements (Skeleton component uses data-slot="skeleton")
  ...
  describe("Message Sending", () => {
    ...
    it("calls onSendMessage with attachments", async () => {
      ...
      // Add attachment - find the hidden file input
