...
public sealed class NotificationRepository(
    ...
    public IQueryable<Notification> Query() => context.Notifications;
...
public sealed class NotificationPreferenceRepository(
    ...
    public IQueryable<NotificationPreference> Query() => context.NotificationPreferences;
...
internal static class NotificationDataLoaders {
    [DataLoader]
    public static async Task<IReadOnlyDictionary<Guid, Notification>> GetNotificationById(
    ...
    [DataLoader]
    public static async Task<ILookup<Guid, Notification>> GetNotificationsByUserId(
        IReadOnlyList<Guid> userIds, AppDbContext context, CancellationToken ct
    ) => (await context.Notifications
    ...
    [DataLoader]
    public static async Task<ILookup<Guid, NotificationPreference>> GetNotificationPreferencesByUserId(
        IReadOnlyList<Guid> userIds, AppDbContext context, CancellationToken ct
