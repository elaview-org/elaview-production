...
import {
  NotificationType,
  type AdvertiserSettingsQuery,
} from "@/types/gql/graphql";
import { NOTIFICATION_LABELS, ADVERTISER_NOTIFICATIONS } from "./constants";

type Props = {
  preferences: AdvertiserSettingsQuery["myNotificationPreferences"];
};
