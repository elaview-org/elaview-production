...
public sealed class ConversationRepository(
    ...
    public IQueryable<Conversation> Query() => context.Conversations;
...
internal static class ConversationDataLoaders {
    [DataLoader]
    public static async Task<IReadOnlyDictionary<Guid, Conversation>> GetConversationById(
    ...
    [DataLoader]
    public static async Task<ILookup<Guid, ConversationParticipant>> GetParticipantsByConversationId(
    ...
    [DataLoader]
    public static async Task<ILookup<Guid, Conversation>> GetConversationsByUserId(
