...
export type OverviewPendingRequests_QueryFragmentFragment = { incomingBookingRequests: { __typename: 'IncomingBookingRequestsConnection', nodes: Array<{ __typename: 'Booking', id: string, startDate: string, endDate: string, totalAmount: number, createdAt: string, campaign: { __typename: 'Campaign', advertiser: { __typename: 'AdvertiserProfile', user: { __typename: 'User', name: string, avatar: string | null } } | null } | null, space: { __typename: 'Space', id: string, title: string } | null }> | null } | null } & { ' $fragmentName'?: 'OverviewPendingRequests_QueryFragmentFragment' };

export type OverviewTopSpaces_QueryFragmentFragment = { mySpaces: { __typename: 'MySpacesConnection', nodes: Array<{ __typename: 'Space', id: string, title: string, images: Array<string>, totalBookings: number, totalRevenue: number, averageRating: number | null, status: SpaceStatus }> | null } | null } & { ' $fragmentName'?: 'OverviewTopSpaces_QueryFragmentFragment' };

export type OverviewDataQueryVariables = Exact<{ [key: string]: never; }>;


export type OverviewDataQuery = (
  { earningsSummary: { __typename: 'EarningsSummary', availableBalance: number | null, pendingPayouts: number | null, thisMonthEarnings: number | null, lastMonthEarnings: number | null } }
  & { ' $fragmentRefs'?: { 'OverviewPendingRequests_QueryFragmentFragment': OverviewPendingRequests_QueryFragmentFragment;'OverviewActiveBookings_QueryFragmentFragment': OverviewActiveBookings_QueryFragmentFragment;'OverviewTopSpaces_QueryFragmentFragment': OverviewTopSpaces_QueryFragmentFragment } }
);
