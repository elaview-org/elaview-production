...
export type SpaceOwnerProfileQuery = { me: { __typename: 'User', id: unknown, name: string, email: string, avatar: string | null, createdAt: unknown, spaceOwnerProfile: { __typename: 'SpaceOwnerProfile', id: unknown, businessName: string | null, businessType: string | null, createdAt: unknown, onboardingComplete: boolean, stripeAccountStatus: string | null, spaces: { __typename: 'SpacesConnection', nodes: Array<{ __typename: 'Space', id: unknown, averageRating: number | null, reviews: { __typename: 'ReviewsConnection', nodes: Array<{ __typename: 'Review', id: unknown, rating: number, comment: string | null, createdAt: unknown, booking: { __typename: 'Booking', campaign: { __typename: 'Campaign', advertiserProfile: { __typename: 'AdvertiserProfile', companyName: string | null, user: { __typename: 'User', name: string, avatar: string | null } } } | null } }> | null } | null }> | null } | null } | null } | null };
