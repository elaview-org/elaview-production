...
export const mockAdvertiserBookings: Booking[] = [
  ...
  },
  {
    ...
    totalPrice: 300,
    dailyRate: 15,
    message: 'Looking to promote our new fitness app. Great fit for your gym audience!',
...
export const mockOwnerBookings: Booking[] = [
  ...
  },
  {
    ...
    totalPrice: 500,
    dailyRate: 25,
    message: 'Our Valentine\'s Day promotion would be perfect for your coffee shop customers!',
