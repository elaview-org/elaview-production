...
export type TableView_SpaceFragmentFragment = { __typename: 'Space', id: unknown, title: string, city: string, state: string, images: Array<string>, type: SpaceType, status: SpaceStatus, createdAt: unknown } & { ' $fragmentName'?: 'TableView_SpaceFragmentFragment' };
...
export type SpaceOwnerListingsQuery = { mySpaces: { __typename: 'MySpacesConnection', nodes: Array<(
      { __typename: 'Space', id: unknown }
      & { ' $fragmentRefs'?: { 'SpaceCard_SpaceFragmentFragment': SpaceCard_SpaceFragmentFragment;'TableView_SpaceFragmentFragment': TableView_SpaceFragmentFragment } }
    )> | null } | null };
...
export const TableView_SpaceFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"TableView_SpaceFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Space"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"images"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}}]}}]} as unknown as DocumentNode<TableView_SpaceFragmentFragment, unknown>;
