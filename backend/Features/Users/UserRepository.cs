...
public interface IUserRepository {
    ...
    //     CancellationToken ct);
    //
    // IQueryable<AdvertiserProfile> GetAdvertiserProfileByUserId(Guid userId);
    //
    ...
    //
    // IQueryable<SpaceOwnerProfile> GetSpaceOwnerProfileByUserId(Guid userId);
    //
...
//         => context.Users.Where(u => u.Id == id).OrderBy(u => u.Id);
//
...
//     }
//
//     public IQueryable<AdvertiserProfile> GetAdvertiserProfileByUserId(Guid userId)
//         => context.AdvertiserProfiles.Where(p => p.UserId == userId).OrderBy(p => p.Id);
//
...
//     }
//
//     public IQueryable<SpaceOwnerProfile> GetSpaceOwnerProfileByUserId(Guid userId)
//         => context.SpaceOwnerProfiles.Where(p => p.UserId == userId).OrderBy(p => p.Id);
//
