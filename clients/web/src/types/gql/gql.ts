...
type Documents = {
  ...
  "\n  fragment OverviewRecentActivity_QueryFragment on Query {\n    myNotifications(first: 10, order: [{ createdAt: DESC }]) {\n      nodes {\n        id\n        type\n        title\n        body\n        createdAt\n        isRead\n      }\n    }\n  }\n": typeof types.OverviewRecentActivity_QueryFragmentFragmentDoc;
...
const documents: Documents = {
  ...
  "\n    fragment AdvertiserOverviewActiveCampaignsCampaignCard_CampaignFragment on Campaign {\n      id\n      name\n      status\n      spacesCount\n      totalBudget\n      totalSpend\n      startDate\n      endDate\n    }\n  ":
    types.AdvertiserOverviewActiveCampaignsCampaignCard_CampaignFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewActiveCampaigns_QueryFragment on Query {\n    myCampaigns(\n      first: 4\n      where: { status: { in: [ACTIVE, SUBMITTED] } }\n      order: [{ createdAt: DESC }]\n    ) {\n      nodes {\n        status\n        ...AdvertiserOverviewActiveCampaignsCampaignCard_CampaignFragment\n      }\n    }\n  }\n":
    types.AdvertiserOverviewActiveCampaigns_QueryFragmentFragmentDoc,
  "\n    fragment AdvertiserOverviewDeadlineWarningsDeadlineCard_BookingFragment on Booking {\n      id\n      space {\n        title\n        owner {\n          user {\n            name\n            avatar\n          }\n        }\n      }\n      campaign {\n        name\n      }\n      proof {\n        submittedAt\n      }\n    }\n  ":
    types.AdvertiserOverviewDeadlineWarningsDeadlineCard_BookingFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewDeadlineWarnings_QueryFragment on Query {\n    deadlineBookings: myBookingsAsAdvertiser(\n      first: 5\n      where: { status: { eq: VERIFIED } }\n      order: [{ proof: { submittedAt: ASC } }]\n    ) {\n      nodes {\n        ...AdvertiserOverviewDeadlineWarningsDeadlineCard_BookingFragment\n      }\n    }\n  }\n":
    types.AdvertiserOverviewDeadlineWarnings_QueryFragmentFragmentDoc,
  "\n    fragment AdvertiserOverviewPendingApprovalsApprovalCard_BookingFragment on Booking {\n      id\n      space {\n        title\n        spaceOwnerProfile {\n          user {\n            name\n            avatar\n          }\n        }\n      }\n      proof {\n        photos\n        submittedAt\n      }\n    }\n  ":
    types.AdvertiserOverviewPendingApprovalsApprovalCard_BookingFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewPendingApprovals_QueryFragment on Query {\n    pendingApprovalsBookings: myBookingsAsAdvertiser(\n      first: 3\n      where: { status: { eq: VERIFIED } }\n      order: [{ createdAt: DESC }]\n    ) {\n      nodes {\n        ...AdvertiserOverviewPendingApprovalsApprovalCard_BookingFragment\n      }\n    }\n  }\n":
    types.AdvertiserOverviewPendingApprovals_QueryFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewPendingPayments_QueryFragment on Query {\n    pendingPayments: myBookingsAsAdvertiser(\n      first: 5\n      where: { status: { eq: APPROVED } }\n      order: [{ createdAt: ASC }]\n    ) {\n      nodes {\n        ...AdvertiserOverviewPendingPaymentsPaymentCard_BookingFragment\n      }\n    }\n  }\n":
    types.AdvertiserOverviewPendingPayments_QueryFragmentFragmentDoc,
  "\n    fragment AdvertiserOverviewPendingPaymentsPaymentCard_BookingFragment on Booking {\n      id\n      totalAmount\n      startDate\n      space {\n        title\n        owner {\n          user {\n            name\n            avatar\n          }\n        }\n      }\n      campaign {\n        name\n      }\n    }\n  ":
    types.AdvertiserOverviewPendingPaymentsPaymentCard_BookingFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewRecentActivity_QueryFragment on Query {\n    myNotifications(first: 10, order: [{ createdAt: DESC }]) {\n      nodes {\n        id\n        type\n        title\n        body\n        createdAt\n        isRead\n      }\n    }\n  }\n":
    types.AdvertiserOverviewRecentActivity_QueryFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewSpendingChart_QueryFragment on Query {\n    spendingChartBookings: myBookingsAsAdvertiser(\n      first: 20\n      where: {\n        status: { in: [PAID, FILE_DOWNLOADED, INSTALLED, VERIFIED, COMPLETED] }\n      }\n    ) {\n      nodes {\n        payments(where: { status: { eq: SUCCEEDED } }) {\n          amount\n          paidAt\n        }\n      }\n    }\n  }\n":
    types.AdvertiserOverviewSpendingChart_QueryFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewStatCards_QueryFragment on Query {\n    me {\n      advertiserProfile {\n        totalSpend\n      }\n    }\n    mySavedPaymentMethods {\n      id\n      isDefault\n    }\n    activeCampaigns: myCampaigns(\n      where: { status: { in: [ACTIVE, SUBMITTED] } }\n    ) {\n      nodes {\n        id\n      }\n    }\n    activeBookings: myBookingsAsAdvertiser(\n      where: { status: { in: [PAID, FILE_DOWNLOADED, INSTALLED, VERIFIED] } }\n    ) {\n      totalCount\n    }\n    pendingApprovals: myBookingsAsAdvertiser(\n      where: { status: { eq: VERIFIED } }\n    ) {\n      totalCount\n    }\n    recentPayments: myBookingsAsAdvertiser(\n      first: 50\n      where: {\n        status: { in: [PAID, FILE_DOWNLOADED, INSTALLED, VERIFIED, COMPLETED] }\n      }\n    ) {\n      nodes {\n        payments(where: { status: { eq: SUCCEEDED } }) {\n          amount\n          paidAt\n        }\n      }\n    }\n  }\n":
    types.AdvertiserOverviewStatCards_QueryFragmentFragmentDoc,
  "\n  fragment AdvertiserOverviewTopSpaces_QueryFragment on Query {\n    topSpacesBookings: myBookingsAsAdvertiser(\n      first: 20\n      where: { status: { in: [COMPLETED, VERIFIED, INSTALLED] } }\n    ) {\n      nodes {\n        totalAmount\n        space {\n          id\n          title\n          images\n          averageRating\n        }\n      }\n    }\n  }\n":
    types.AdvertiserOverviewTopSpaces_QueryFragmentFragmentDoc,
  "\n      query AdvertiserOverviewData {\n        ...AdvertiserOverviewStatCards_QueryFragment\n        ...AdvertiserOverviewDeadlineWarnings_QueryFragment\n        ...AdvertiserOverviewPendingPayments_QueryFragment\n        ...AdvertiserOverviewPendingApprovals_QueryFragment\n        ...AdvertiserOverviewActiveCampaigns_QueryFragment\n        ...AdvertiserOverviewTopSpaces_QueryFragment\n        ...AdvertiserOverviewSpendingChart_QueryFragment\n        ...AdvertiserOverviewRecentActivity_QueryFragment\n      }\n    ":
    types.AdvertiserOverviewDataDocument,
  "\n  fragment AnalyticsBookingsChart_QueryFragment on Query {\n    spaceOwnerDailyStats(startDate: $startDate, endDate: $endDate) {\n      date\n      bookings\n    }\n  }\n":
  ...
  "\n  fragment AnalyticsMonthlyChart_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      monthlyStats(months: 12) {\n        month\n        revenue\n        bookings\n      }\n    }\n  }\n":
    types.AnalyticsMonthlyChart_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsPerformanceTable_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      spacePerformance(first: 10) {\n        id\n        title\n        image\n        totalBookings\n        totalRevenue\n        averageRating\n        occupancyRate\n      }\n    }\n  }\n":
    types.AnalyticsPerformanceTable_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsRatingChart_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      ratingTrends(months: 12) {\n        month\n        rating\n        reviews\n      }\n    }\n  }\n":
    types.AnalyticsRatingChart_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsRevenueChart_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      spacePerformance(first: 10) {\n        id\n        title\n        totalRevenue\n      }\n    }\n  }\n":
    types.AnalyticsRevenueChart_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsStatusChart_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      statusDistribution {\n        status\n        count\n      }\n    }\n  }\n":
    types.AnalyticsStatusChart_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsSummary_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      summary {\n        totalBookings\n        previousTotalBookings\n        totalRevenue\n        previousTotalRevenue\n        averageRating\n        completionRate\n        avgBookingDuration\n        previousAvgBookingDuration\n        occupancyRate\n        previousOccupancyRate\n        repeatAdvertiserRate\n        previousRepeatAdvertiserRate\n        forecastedRevenue\n      }\n    }\n  }\n":
    types.AnalyticsSummary_QueryFragmentFragmentDoc,
  "\n  fragment AnalyticsTopPerformers_QueryFragment on Query {\n    spaceOwnerAnalytics(startDate: $startDate, endDate: $endDate) {\n      topPerformers {\n        bestRevenue {\n          id\n          title\n          value\n          change\n        }\n        bestRating {\n          id\n          title\n          value\n          reviews\n        }\n        bestOccupancy {\n          id\n          title\n          value\n          change\n        }\n        mostBookings {\n          id\n          title\n          value\n          change\n        }\n        needsAttention {\n          id\n          title\n          occupancy\n          bookings\n        }\n      }\n    }\n  }\n":
    types.AnalyticsTopPerformers_QueryFragmentFragmentDoc,
  "\n      # noinspection GraphQLSchemaValidation\n      query AnalyticsData($startDate: DateTime!, $endDate: DateTime!) {\n        ...AnalyticsSummary_QueryFragment\n        ...AnalyticsBookingsChart_QueryFragment\n        ...AnalyticsStatusChart_QueryFragment\n        ...AnalyticsMonthlyChart_QueryFragment\n        ...AnalyticsRatingChart_QueryFragment\n        ...AnalyticsHeatmapChart_QueryFragment\n        ...AnalyticsComparison_QueryFragment\n        ...AnalyticsTopPerformers_QueryFragment\n        ...AnalyticsRevenueChart_QueryFragment\n        ...AnalyticsPerformanceTable_QueryFragment\n      }\n    ":
    types.AnalyticsDataDocument,
  "\n  fragment BookingCard_BookingFragment on Booking {\n    id\n    status\n    startDate\n    endDate\n    ownerPayoutAmount\n    space {\n      title\n      images\n    }\n    campaign {\n      name\n      advertiserProfile {\n        companyName\n      }\n    }\n  }\n":
    types.BookingCard_BookingFragmentFragmentDoc,
  "\n  fragment BookingsTable_BookingFragment on Booking {\n    id\n    status\n    startDate\n    endDate\n    ownerPayoutAmount\n    space {\n      title\n      images\n    }\n    campaign {\n      name\n      imageUrl\n      advertiserProfile {\n        companyName\n      }\n    }\n  }\n":
    types.BookingsTable_BookingFragmentFragmentDoc,
  "\n        query BookingDetail($id: ID!) {\n          bookingById(id: $id) {\n            id\n            status\n            startDate\n            endDate\n            createdAt\n            totalDays\n            pricePerDay\n            subtotalAmount\n            installationFee\n            platformFeeAmount\n            platformFeePercent\n            totalAmount\n            ownerPayoutAmount\n            ownerNotes\n            advertiserNotes\n            rejectionReason\n            rejectedAt\n            cancellationReason\n            cancelledAt\n            fileDownloadedAt\n            space {\n              id\n              title\n              images\n              address\n              city\n              state\n              zipCode\n            }\n            campaign {\n              id\n              name\n              imageUrl\n              advertiserProfile {\n                companyName\n                user {\n                  name\n                  avatar\n                }\n              }\n            }\n            proof {\n              id\n              status\n              photos\n              submittedAt\n              autoApproveAt\n              rejectionReason\n            }\n            dispute {\n              id\n              issueType\n              reason\n              photos\n              disputedAt\n              resolutionAction\n              resolutionNotes\n              resolvedAt\n            }\n            payouts {\n              id\n              amount\n              stage\n              status\n              processedAt\n            }\n          }\n        }\n      ":
    types.BookingDetailDocument,
  "\n        mutation ApproveBooking($input: ApproveBookingInput!) {\n          approveBooking(input: $input) {\n            booking {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
  ...
  "\n        mutation MarkFileDownloaded($input: MarkFileDownloadedInput!) {\n          markFileDownloaded(input: $input) {\n            booking {\n              id\n              status\n              fileDownloadedAt\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.MarkFileDownloadedDocument,
  "\n        mutation MarkInstalled($input: MarkInstalledInput!) {\n          markInstalled(input: $input) {\n            booking {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.MarkInstalledDocument,
  "\n        mutation SubmitProof($input: SubmitProofInput!) {\n          submitProof(input: $input) {\n            booking {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.SubmitProofDocument,
  "\n        mutation CreateBookingConversation(\n          $input: CreateBookingConversationInput!\n        ) {\n          createBookingConversation(input: $input) {\n            conversation {\n              id\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.CreateBookingConversationDocument,
  "\n        query SpaceOwnerBookings(\n          $first: Int\n          $after: String\n          $where: BookingFilterInput\n          $order: [BookingSortInput!]\n          $searchText: String\n        ) {\n          myBookingsAsOwner(\n            first: $first\n            after: $after\n            where: $where\n            order: $order\n            searchText: $searchText\n          ) {\n            nodes {\n              id\n              ...BookingCard_BookingFragment\n              ...BookingsTable_BookingFragment\n            }\n            pageInfo {\n              hasNextPage\n              hasPreviousPage\n              startCursor\n              endCursor\n            }\n            totalCount\n          }\n        }\n      ":
    types.SpaceOwnerBookingsDocument,
  "\n  fragment BalanceCards_EarningsSummaryFragment on EarningsSummary {\n    availableBalance\n    pendingPayouts\n    thisMonthEarnings\n    lastMonthEarnings\n    totalEarnings\n  }\n":
    types.BalanceCards_EarningsSummaryFragmentFragmentDoc,
  "\n        mutation RequestManualPayout($input: RequestManualPayoutInput!) {\n          requestManualPayout(input: $input) {\n            manualPayout {\n              id\n              amount\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.RequestManualPayoutDocument,
  "\n        query SpaceOwnerEarnings {\n          me {\n            spaceOwnerProfile {\n              stripeAccountStatus\n            }\n          }\n          earningsSummary {\n            ...BalanceCards_EarningsSummaryFragment\n          }\n          myPayouts {\n            nodes {\n              id\n              amount\n              processedAt\n              ...PayoutsTable_PayoutFragment\n            }\n          }\n        }\n      ":
    types.SpaceOwnerEarningsDocument,
  "\n  fragment PayoutsTable_PayoutFragment on Payout {\n    id\n    amount\n    stage\n    status\n    processedAt\n    booking {\n      id\n      space {\n        title\n      }\n    }\n  }\n":
    types.PayoutsTable_PayoutFragmentFragmentDoc,
  "\n        query SpaceOwnerPayoutsHistory(\n          $first: Int\n          $after: String\n          $where: PayoutFilterInput\n          $order: [PayoutSortInput!]\n        ) {\n          myPayouts(\n            first: $first\n            after: $after\n            where: $where\n            order: $order\n          ) {\n            nodes {\n              id\n              ...PayoutsHistoryTable_PayoutFragment\n            }\n            pageInfo {\n              hasNextPage\n              hasPreviousPage\n              startCursor\n              endCursor\n            }\n          }\n        }\n      ":
    types.SpaceOwnerPayoutsHistoryDocument,
  "\n  fragment PayoutsHistoryTable_PayoutFragment on Payout {\n    id\n    amount\n    stage\n    status\n    processedAt\n    failureReason\n    attemptCount\n    booking {\n      id\n      space {\n        title\n      }\n    }\n  }\n":
    types.PayoutsHistoryTable_PayoutFragmentFragmentDoc,
  "\n        mutation RetryPayout($input: RetryPayoutInput!) {\n          retryPayout(input: $input) {\n            payout {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.RetryPayoutDocument,
  "\n  fragment SpaceCard_SpaceFragment on Space {\n    id\n    title\n    description\n    city\n    state\n    images\n    type\n    status\n    createdAt\n  }\n":
    types.SpaceCard_SpaceFragmentFragmentDoc,
  "\n  fragment ListingsMap_SpaceFragment on Space {\n    id\n    title\n    latitude\n    longitude\n    pricePerDay\n  }\n":
    types.ListingsMap_SpaceFragmentFragmentDoc,
  "\n  fragment ListingsTable_SpaceFragment on Space {\n    id\n    title\n    city\n    state\n    images\n    type\n    status\n    createdAt\n  }\n":
    types.ListingsTable_SpaceFragmentFragmentDoc,
  "\n        query SpaceBookings($spaceId: UUID!, $first: Int) {\n          myBookingsAsOwner(\n            first: $first\n            where: { spaceId: { eq: $spaceId } }\n            order: [{ startDate: DESC }]\n          ) {\n            nodes {\n              id\n              status\n              startDate\n              endDate\n              totalAmount\n              campaign {\n                name\n                advertiserProfile {\n                  companyName\n                }\n              }\n            }\n          }\n        }\n      ":
    types.SpaceBookingsDocument,
  "\n        query SpaceBlockedDates($spaceId: ID!, $first: Int) {\n          blockedDatesBySpace(spaceId: $spaceId, first: $first) {\n            nodes {\n              id\n              date\n            }\n          }\n        }\n      ":
    types.SpaceBlockedDatesDocument,
  "\n        mutation BlockDates($input: BlockDatesInput!) {\n          blockDates(input: $input) {\n            blockedDates {\n              id\n              date\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
  ...
  "\n        query SpaceReviews($spaceId: ID!, $first: Int) {\n          reviewsBySpace(\n            spaceId: $spaceId\n            first: $first\n            order: [{ createdAt: DESC }]\n          ) {\n            nodes {\n              id\n              rating\n              comment\n              createdAt\n              reviewer {\n                name\n                avatar\n              }\n            }\n          }\n        }\n      ":
    types.SpaceReviewsDocument,
  "\n        mutation CreateSpace($input: CreateSpaceInput!) {\n          createSpace(input: $input) {\n            space {\n              id\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.CreateSpaceDocument,
  "\n        mutation UpdateSpace($id: ID!, $input: UpdateSpaceInput!) {\n          updateSpace(id: $id, input: $input) {\n            space {\n              id\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.UpdateSpaceDocument,
  "\n        mutation UpdateSpaceImages($id: ID!, $input: UpdateSpaceInput!) {\n          updateSpace(id: $id, input: $input) {\n            space {\n              id\n              images\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.UpdateSpaceImagesDocument,
  "\n        mutation DeactivateSpace($input: DeactivateSpaceInput!) {\n          deactivateSpace(input: $input) {\n            space {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.DeactivateSpaceDocument,
  "\n        mutation ReactivateSpace($input: ReactivateSpaceInput!) {\n          reactivateSpace(input: $input) {\n            space {\n              id\n              status\n            }\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.ReactivateSpaceDocument,
  "\n        mutation DeleteSpace($input: DeleteSpaceInput!) {\n          deleteSpace(input: $input) {\n            success\n            errors {\n              ... on Error {\n                message\n              }\n            }\n          }\n        }\n      ":
    types.DeleteSpaceDocument,
  "\n          mutation BulkDeactivateSpace($input: DeactivateSpaceInput!) {\n            deactivateSpace(input: $input) {\n              space {\n                id\n              }\n              errors {\n                ... on Error {\n                  message\n                }\n              }\n            }\n          }\n        ":
    types.BulkDeactivateSpaceDocument,
  "\n          mutation BulkDeleteSpace($input: DeleteSpaceInput!) {\n            deleteSpace(input: $input) {\n              success\n              errors {\n                ... on Error {\n                  message\n                }\n              }\n            }\n          }\n        ":
  ...
  "\n  fragment OverviewActivityChart_QueryFragment on Query {\n    myPayouts(first: 20, order: [{ processedAt: DESC }]) {\n      nodes {\n        amount\n        processedAt\n      }\n    }\n  }\n":
    types.OverviewActivityChart_QueryFragmentFragmentDoc,
  "\n  fragment OverviewDeadlineWarningsDeadlineCard_BookingFragment on Booking {\n    id\n    status\n    startDate\n    endDate\n    space {\n      title\n    }\n    campaign {\n      name\n      advertiser {\n        user {\n          name\n          avatar\n        }\n      }\n    }\n  }\n":
    types.OverviewDeadlineWarningsDeadlineCard_BookingFragmentFragmentDoc,
  "\n  fragment OverviewDeadlineWarnings_QueryFragment on Query {\n    deadlineBookings: myBookingsAsOwner(\n      first: 5\n      where: { status: { in: [FILE_DOWNLOADED, INSTALLED] } }\n      order: [{ endDate: ASC }]\n    ) {\n      nodes {\n        ...OverviewDeadlineWarningsDeadlineCard_BookingFragment\n      }\n    }\n  }\n":
    types.OverviewDeadlineWarnings_QueryFragmentFragmentDoc,
  "\n  fragment OverviewPendingRequests_QueryFragment on Query {\n    incomingBookingRequests(first: 5) {\n      nodes {\n        ...OverviewPendingRequestsRequestCard_BookingFragment\n      }\n    }\n  }\n":
  ...
  "\n  fragment OverviewRecentActivity_QueryFragment on Query {\n    myNotifications(first: 10, order: [{ createdAt: DESC }]) {\n      nodes {\n        id\n        type\n        title\n        body\n        createdAt\n        isRead\n      }\n    }\n  }\n":
    types.OverviewRecentActivity_QueryFragmentFragmentDoc,
  "\n  fragment OverviewStatCards_QueryFragment on Query {\n    me {\n      spaceOwnerProfile {\n        stripeAccountStatus\n      }\n    }\n    earningsSummary {\n      availableBalance\n      pendingPayouts\n      thisMonthEarnings\n      lastMonthEarnings\n    }\n    activeBookings: myBookingsAsOwner(\n      where: { status: { in: [PAID, FILE_DOWNLOADED, INSTALLED, VERIFIED] } }\n    ) {\n      totalCount\n    }\n    mySpaces {\n      totalCount\n    }\n  }\n":
  ...
  "\n  fragment OverviewUpcomingPayouts_QueryFragment on Query {\n    upcomingPayouts: myPayouts(\n      first: 5\n      where: { status: { in: [PENDING, PROCESSING] } }\n      order: [{ createdAt: ASC }]\n    ) {\n      nodes {\n        ...OverviewUpcomingPayoutsPayoutCard_PayoutFragment\n      }\n    }\n  }\n":
    types.OverviewUpcomingPayouts_QueryFragmentFragmentDoc,
  "\n  fragment OverviewUpcomingPayoutsPayoutCard_PayoutFragment on Payout {\n    id\n    amount\n    stage\n    status\n    createdAt\n    booking {\n      space {\n        title\n      }\n    }\n  }\n":
