...
import HeroNavigation from '@/components/landing/hero-navigation';
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex -space-x-2.5">
                {[1, 2, 3, 4, 5].map((i) => (
                  <div
                    key={i}
                    className="h-9 w-9 rounded-full border-2 border-white/20 overflow-hidden ring-1 ring-black/20"
                  >
                    <Image
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-white/50">
                  Trusted by <span className="text-white/80 font-medium">500+</span> advertisers & space owners
                </p>
              </div>
            </div>
          </div>
