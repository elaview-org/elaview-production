...
export const mockConversations: Conversation[] = [
  {
    ...
    lastMessage:
      "Your installation looks great! I've approved the verification.",
    ...
    messages: [
      {
        ...
        content:
          "Hi Sarah! I just submitted the installation photo for verification.",
  ...
  },
  {
    ...
    lastMessage:
      "Please let me know if you need any help with the content format.",
    ...
    messages: [
      {
        ...
        content:
          "Welcome! Your booking has been confirmed. The screen supports 1080p video.",
    ...
    messages: [
      {
        ...
        senderName: "Alex Johnson",
        content:
          "Hi Mike, I just submitted a booking request for your poster board.",
  ...
  },
  {
    ...
    messages: [
      ...
      },
      {
        ...
        content:
          "You can update your payment method in Profile > Payment Methods. Tap the card you want to update or add a new one.",
