...
export type ApproveProofError = ForbiddenError | InvalidStatusTransitionError | NotFoundError;

export type ApproveProofInput = {
  bookingId: Scalars['ID']['input'];
};

export type ApproveProofPayload = {
  __typename: 'ApproveProofPayload';
  booking: Maybe<Booking>;
  errors: Maybe<Array<ApproveProofError>>;
};
...
export type DisputeProofError = ForbiddenError | InvalidStatusTransitionError | NotFoundError;

export type DisputeProofInput = {
  bookingId: Scalars['ID']['input'];
  issueType: DisputeIssueType;
...
export type DisputeProofPayload = {
  __typename: 'DisputeProofPayload';
  booking: Maybe<Booking>;
  errors: Maybe<Array<DisputeProofError>>;
};
...
export type Mutation = {
  ...
  approveProof: ApproveProofPayload;
...
export type MutationApproveProofArgs = {
...
export type MutationDisputeProofArgs = {
  input: DisputeProofInput;
};
...
/** A connection to a list of items. */
export type MyPaymentsConnection = {
  __typename: 'MyPaymentsConnection';
  /** A list of edges. */
  edges: Maybe<Array<MyPaymentsEdge>>;
  /** A flattened list of the nodes. */
...
/** An edge in a connection. */
export type MyPaymentsEdge = {
  __typename: 'MyPaymentsEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: Payment;
...
export type SpendingSummary = {
  ...
  lastMonthSpending: Maybe<Scalars['Decimal']['output']>;
  pendingPayments: Maybe<Scalars['Decimal']['output']>;
  thisMonthSpending: Maybe<Scalars['Decimal']['output']>;
  totalSpent: Maybe<Scalars['Decimal']['output']>;
};
...
export type AdvertiserBookingDetailQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type AdvertiserBookingDetailQuery = { bookingById: { __typename: 'Booking', id: string, status: BookingStatus, startDate: string, endDate: string, createdAt: string, totalDays: number, pricePerDay: number, subtotalAmount: number, installationFee: number, platformFeeAmount: number, platformFeePercent: number, totalAmount: number, advertiserNotes: string | null, rejectionReason: string | null, rejectedAt: string | null, cancellationReason: string | null, cancelledAt: string | null, space: { __typename: 'Space', id: string, title: string, images: Array<string>, address: string, city: string, state: string, zipCode: string | null, owner: { __typename: 'SpaceOwnerProfile', businessName: string | null, user: { __typename: 'User', name: string, avatar: string | null } } | null } | null, campaign: { __typename: 'Campaign', id: string, name: string, imageUrl: string } | null, proof: { __typename: 'BookingProof', id: string, status: ProofStatus, photos: Array<string>, submittedAt: string, autoApproveAt: string, rejectionReason: string | null } | null, dispute: { __typename: 'BookingDispute', id: string, issueType: DisputeIssueType, reason: string, photos: Array<string>, disputedAt: string, resolutionAction: string | null, resolutionNotes: string | null, resolvedAt: string | null } | null, payments: Array<{ __typename: 'Payment', id: string, amount: number, status: PaymentStatus, createdAt: string }> } | null };

export type AdvertiserCancelBookingMutationVariables = Exact<{
  input: CancelBookingInput;
}>;


export type AdvertiserCancelBookingMutation = { cancelBooking: { __typename: 'CancelBookingPayload', booking: { __typename: 'Booking', id: string, status: BookingStatus } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };

export type ApproveProofMutationVariables = Exact<{
  input: ApproveProofInput;
}>;


export type ApproveProofMutation = { approveProof: { __typename: 'ApproveProofPayload', booking: { __typename: 'Booking', id: string, status: BookingStatus } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };

export type DisputeProofMutationVariables = Exact<{
  input: DisputeProofInput;
}>;


export type DisputeProofMutation = { disputeProof: { __typename: 'DisputeProofPayload', booking: { __typename: 'Booking', id: string, status: BookingStatus } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };

export type AdvertiserCreateBookingConversationMutationVariables = Exact<{
  input: CreateBookingConversationInput;
}>;


export type AdvertiserCreateBookingConversationMutation = { createBookingConversation: { __typename: 'CreateBookingConversationPayload', conversation: { __typename: 'Conversation', id: string } | null, errors: Array<{ __typename: 'NotFoundError', message: string }> | null } };

export type AdvertiserBookingsQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<BookingFilterInput>;
...
export type AdvertiserBookingsQuery = { myBookingsAsAdvertiser: { __typename: 'MyBookingsAsAdvertiserConnection', totalCount: number, nodes: Array<(
...
export type ActionsBar_CampaignFragmentFragment = { __typename: 'Campaign', id: string, status: CampaignStatus } & { ' $fragmentName'?: 'ActionsBar_CampaignFragmentFragment' };

export type CampaignBookingsQueryVariables = Exact<{
  id: Scalars['ID']['input'];
  first?: InputMaybe<Scalars['Int']['input']>;
}>;


export type CampaignBookingsQuery = { campaignById: { __typename: 'Campaign', bookings: { __typename: 'BookingsConnection', nodes: Array<{ __typename: 'Booking', id: string, status: BookingStatus, startDate: string, endDate: string, totalAmount: number, space: { __typename: 'Space', title: string } | null }> | null } | null } | null };

export type Details_CampaignFragmentFragment = { __typename: 'Campaign', id: string, name: string, description: string | null, goals: string | null, targetAudience: string | null, startDate: string | null, endDate: string | null, totalBudget: number | null } & { ' $fragmentName'?: 'Details_CampaignFragmentFragment' };

export type Gallery_CampaignFragmentFragment = { __typename: 'Campaign', id: string, name: string, imageUrl: string } & { ' $fragmentName'?: 'Gallery_CampaignFragmentFragment' };

export type Header_CampaignFragmentFragment = { __typename: 'Campaign', id: string, name: string, status: CampaignStatus } & { ' $fragmentName'?: 'Header_CampaignFragmentFragment' };
...
export type CampaignDetailQuery = { campaignById: (
    { __typename: 'Campaign', id: string }
    & { ' $fragmentRefs'?: { 'Header_CampaignFragmentFragment': Header_CampaignFragmentFragment;'Gallery_CampaignFragmentFragment': Gallery_CampaignFragmentFragment;'Details_CampaignFragmentFragment': Details_CampaignFragmentFragment;'Performance_CampaignFragmentFragment': Performance_CampaignFragmentFragment;'ActionsBar_CampaignFragmentFragment': ActionsBar_CampaignFragmentFragment } }
  ) | null };

export type Performance_CampaignFragmentFragment = { __typename: 'Campaign', spacesCount: number, totalSpend: number, totalBudget: number | null } & { ' $fragmentName'?: 'Performance_CampaignFragmentFragment' };
...
export type CreateCampaignMutation = { createCampaign: { __typename: 'CreateCampaignPayload', campaign: { __typename: 'Campaign', id: string } | null, errors: Array<{ __typename: 'NotFoundError', message: string }> | null } };
...
export type UpdateCampaignMutation = { updateCampaign: { __typename: 'UpdateCampaignPayload', campaign: { __typename: 'Campaign', id: string } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };

export type UpdateCampaignImageMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  input: UpdateCampaignInput;
}>;


export type UpdateCampaignImageMutation = { updateCampaign: { __typename: 'UpdateCampaignPayload', campaign: { __typename: 'Campaign', id: string, imageUrl: string } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };

export type SubmitCampaignMutationVariables = Exact<{
  input: SubmitCampaignInput;
}>;


export type SubmitCampaignMutation = { submitCampaign: { __typename: 'SubmitCampaignPayload', campaign: { __typename: 'Campaign', id: string, status: CampaignStatus } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };
...
export type CancelCampaignMutation = { cancelCampaign: { __typename: 'CancelCampaignPayload', campaign: { __typename: 'Campaign', id: string, status: CampaignStatus } | null, errors: Array<
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };
...
export type DeleteCampaignMutation = { deleteCampaign: { __typename: 'DeleteCampaignPayload', success: boolean | null, errors: Array<
      | { __typename: 'ConflictError', message: string }
      | { __typename: 'ForbiddenError', message: string }
      | { __typename: 'NotFoundError', message: string }
    > | null } };
...
export type AdvertiserCampaignsQueryVariables = Exact<{
  ...
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<CampaignFilterInput>;
  order?: InputMaybe<Array<CampaignSortInput> | CampaignSortInput>;
}>;
...
export type DiscoverSpaceCard_SpaceFragmentFragment = { __typename: 'Space', id: string, title: string, description: string | null, city: string, state: string, images: Array<string>, type: SpaceType, pricePerDay: number, averageRating: number | null } & { ' $fragmentName'?: 'DiscoverSpaceCard_SpaceFragmentFragment' };

export type DiscoverMap_SpaceFragmentFragment = { __typename: 'Space', id: string, title: string, address: string, city: string, latitude: number, longitude: number, pricePerDay: number, type: SpaceType, images: Array<string> } & { ' $fragmentName'?: 'DiscoverMap_SpaceFragmentFragment' };

export type DiscoverTable_SpaceFragmentFragment = { __typename: 'Space', id: string, title: string, city: string, state: string, images: Array<string>, type: SpaceType, pricePerDay: number, averageRating: number | null } & { ' $fragmentName'?: 'DiscoverTable_SpaceFragmentFragment' };

export type DiscoverSpacesQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
...
export type AdvertiserSpendingQueryVariables = Exact<{
  startDate: Scalars['DateTime']['input'];
  endDate: Scalars['DateTime']['input'];
  paymentWhere?: InputMaybe<PaymentFilterInput>;
}>;


export type AdvertiserSpendingQuery = { advertiserSpendingSummary: (
    { __typename: 'SpendingSummary' }
    & { ' $fragmentRefs'?: { 'SpendingCards_SpendingSummaryFragmentFragment': SpendingCards_SpendingSummaryFragmentFragment } }
  ), advertiserDailyStats: Array<{ __typename: 'DailyStats', date: string, spending: number }>, activeCampaigns: { __typename: 'MyCampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: string, name: string }> | null } | null, myPayments: { __typename: 'MyPaymentsConnection', nodes: Array<(
      { __typename: 'Payment', id: string }
      & { ' $fragmentRefs'?: { 'PaymentsTable_PaymentFragmentFragment': PaymentsTable_PaymentFragmentFragment } }
    )> | null } | null, mySavedPaymentMethods: Array<{ __typename: 'SavedPaymentMethod', id: string, brand: string, last4: string, expMonth: number, expYear: number, isDefault: boolean }> };

export type PaymentsTable_PaymentFragmentFragment = { __typename: 'Payment', id: string, amount: number, status: PaymentStatus, type: PaymentType, createdAt: string, paidAt: string | null, receiptUrl: string | null, booking: { __typename: 'Booking', id: string, space: { __typename: 'Space', title: string, images: Array<string> } | null, campaign: { __typename: 'Campaign', name: string } | null } } & { ' $fragmentName'?: 'PaymentsTable_PaymentFragmentFragment' };

export type AdvertiserPaymentsHistoryQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  where?: InputMaybe<PaymentFilterInput>;
  order?: InputMaybe<Array<PaymentSortInput> | PaymentSortInput>;
}>;


export type AdvertiserPaymentsHistoryQuery = { myPayments: { __typename: 'MyPaymentsConnection', nodes: Array<(
      { __typename: 'Payment', id: string }
      & { ' $fragmentRefs'?: { 'PaymentsHistoryTable_PaymentFragmentFragment': PaymentsHistoryTable_PaymentFragmentFragment } }
    )> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null, allCampaigns: { __typename: 'MyCampaignsConnection', nodes: Array<{ __typename: 'Campaign', id: string, name: string }> | null } | null };

export type PaymentsHistoryTable_PaymentFragmentFragment = { __typename: 'Payment', id: string, amount: number, status: PaymentStatus, type: PaymentType, createdAt: string, paidAt: string | null, failureReason: string | null, receiptUrl: string | null, booking: { __typename: 'Booking', id: string, space: { __typename: 'Space', title: string, images: Array<string> } | null, campaign: { __typename: 'Campaign', name: string } | null } } & { ' $fragmentName'?: 'PaymentsHistoryTable_PaymentFragmentFragment' };

export type SpendingCards_SpendingSummaryFragmentFragment = { __typename: 'SpendingSummary', totalSpent: number | null, pendingPayments: number | null, thisMonthSpending: number | null, lastMonthSpending: number | null } & { ' $fragmentName'?: 'SpendingCards_SpendingSummaryFragmentFragment' };
...
export type RequestRefundMutation = { requestRefund: { __typename: 'RequestRefundPayload', refund: { __typename: 'Refund', id: string, amount: number, status: RefundStatus } | null, errors: Array<
      | { __typename: 'InvalidStatusTransitionError', message: string }
      | { __typename: 'NotFoundError', message: string }
...
export type OwnerCard_SpaceFragmentFragment = { __typename: 'Space', averageRating: number | null, spaceOwnerProfile: { __typename: 'SpaceOwnerProfile', businessName: string | null, user: { __typename: 'User', name: string, avatar: string | null } } } & { ' $fragmentName'?: 'OwnerCard_SpaceFragmentFragment' };
...
export type FeaturedSpacesQuery = { spaces: { __typename: 'SpacesConnection', nodes: Array<(
      { __typename: 'Space', id: string }
      & { ' $fragmentRefs'?: { 'FeaturedSpaceCard_SpaceFragmentFragment': FeaturedSpaceCard_SpaceFragmentFragment } }
    )> | null } | null };

export type PublicSpaceDetailQueryVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type PublicSpaceDetailQuery = { spaceById: { __typename: 'Space', id: string, title: string, description: string | null, images: Array<string>, type: SpaceType, status: SpaceStatus, city: string, state: string, address: string, zipCode: string | null, pricePerDay: number, installationFee: number | null, minDuration: number, maxDuration: number | null, dimensions: string | null, dimensionsText: string | null, width: number | null, height: number | null, traffic: string | null, averageRating: number | null, totalBookings: number, spaceOwnerProfile: { __typename: 'SpaceOwnerProfile', businessName: string | null, user: { __typename: 'User', name: string, avatar: string | null } } } | null };

export type PublicBrowseSpacesQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
...
export type PublicBrowseSpacesQuery = { spaces: { __typename: 'SpacesConnection', totalCount: number, nodes: Array<(
      { __typename: 'Space', id: string }
      & { ' $fragmentRefs'?: { 'PublicSpacesSpaceCard_SpaceFragmentFragment': PublicSpacesSpaceCard_SpaceFragmentFragment } }
    )> | null, pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor: string | null, endCursor: string | null } } | null };
...
export const ActionsBar_CampaignFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ActionsBar_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]} as unknown as DocumentNode<ActionsBar_CampaignFragmentFragment, unknown>;
export const Details_CampaignFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Details_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"goals"}},{"kind":"Field","name":{"kind":"Name","value":"targetAudience"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}}]}}]} as unknown as DocumentNode<Details_CampaignFragmentFragment, unknown>;
export const Gallery_CampaignFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Gallery_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}}]} as unknown as DocumentNode<Gallery_CampaignFragmentFragment, unknown>;
export const Header_CampaignFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Header_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]} as unknown as DocumentNode<Header_CampaignFragmentFragment, unknown>;
export const Performance_CampaignFragmentFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Performance_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spacesCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalSpend"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}}]}}]} as unknown as DocumentNode<Performance_CampaignFragmentFragment, unknown>;
...
export const ApproveProofDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ApproveProof"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ApproveProofInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"approveProof"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"booking"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ApproveProofMutation, ApproveProofMutationVariables>;
export const DisputeProofDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DisputeProof"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DisputeProofInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"disputeProof"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"booking"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DisputeProofMutation, DisputeProofMutationVariables>;
export const AdvertiserCreateBookingConversationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AdvertiserCreateBookingConversation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CreateBookingConversationInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"createBookingConversation"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"conversation"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<AdvertiserCreateBookingConversationMutation, AdvertiserCreateBookingConversationMutationVariables>;
export const AdvertiserBookingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdvertiserBookings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"where"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingFilterInput"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"order"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"BookingSortInput"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"searchText"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myBookingsAsAdvertiser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"where"}}},{"kind":"Argument","name":{"kind":"Name","value":"order"},"value":{"kind":"Variable","name":{"kind":"Name","value":"order"}}},{"kind":"Argument","name":{"kind":"Name","value":"searchText"},"value":{"kind":"Variable","name":{"kind":"Name","value":"searchText"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BookingCard_AdvertiserBookingFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"BookingsTable_AdvertiserBookingFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPreviousPage"}},{"kind":"Field","name":{"kind":"Name","value":"startCursor"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalCount"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BookingCard_AdvertiserBookingFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Booking"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"space"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"images"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"businessName"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"BookingsTable_AdvertiserBookingFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Booking"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"space"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"images"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"businessName"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]}}]} as unknown as DocumentNode<AdvertiserBookingsQuery, AdvertiserBookingsQueryVariables>;
export const CampaignBookingsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CampaignBookings"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"bookings"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalAmount"}},{"kind":"Field","name":{"kind":"Name","value":"space"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"title"}}]}}]}}]}}]}}]}}]} as unknown as DocumentNode<CampaignBookingsQuery, CampaignBookingsQueryVariables>;
export const CampaignDetailDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"CampaignDetail"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaignById"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"Header_CampaignFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"Gallery_CampaignFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"Details_CampaignFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"Performance_CampaignFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"ActionsBar_CampaignFragment"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Header_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Gallery_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Details_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"goals"}},{"kind":"Field","name":{"kind":"Name","value":"targetAudience"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"Performance_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spacesCount"}},{"kind":"Field","name":{"kind":"Name","value":"totalSpend"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"ActionsBar_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]} as unknown as DocumentNode<CampaignDetailQuery, CampaignDetailQueryVariables>;
...
export const UpdateCampaignDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCampaign"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCampaignInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<UpdateCampaignMutation, UpdateCampaignMutationVariables>;
export const UpdateCampaignImageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateCampaignImage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"UpdateCampaignInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<UpdateCampaignImageMutation, UpdateCampaignImageMutationVariables>;
export const SubmitCampaignDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubmitCampaign"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SubmitCampaignInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"submitCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<SubmitCampaignMutation, SubmitCampaignMutationVariables>;
export const CancelCampaignDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"CancelCampaign"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CancelCampaignInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"cancelCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"campaign"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<CancelCampaignMutation, CancelCampaignMutationVariables>;
export const DeleteCampaignDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeleteCampaign"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteCampaignInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteCampaign"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"success"}},{"kind":"Field","name":{"kind":"Name","value":"errors"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Error"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"message"}}]}}]}}]}}]}}]} as unknown as DocumentNode<DeleteCampaignMutation, DeleteCampaignMutationVariables>;
export const AdvertiserCampaignsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"AdvertiserCampaigns"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"where"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"CampaignFilterInput"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"order"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"CampaignSortInput"}}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"myCampaigns"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"where"}}},{"kind":"Argument","name":{"kind":"Name","value":"order"},"value":{"kind":"Variable","name":{"kind":"Name","value":"order"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"CampaignCard_CampaignFragment"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"CampaignsTable_CampaignFragment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPreviousPage"}},{"kind":"Field","name":{"kind":"Name","value":"startCursor"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CampaignCard_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"bookings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"CampaignsTable_CampaignFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Campaign"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"startDate"}},{"kind":"Field","name":{"kind":"Name","value":"endDate"}},{"kind":"Field","name":{"kind":"Name","value":"totalBudget"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"bookings"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]}}]} as unknown as DocumentNode<AdvertiserCampaignsQuery, AdvertiserCampaignsQueryVariables>;
export const DiscoverSpacesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"DiscoverSpaces"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"first"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"last"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"after"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"before"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"order"}},"type":{"kind":"ListType","type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"SpaceSortInput"}}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"where"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"SpaceFilterInput"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"gridView"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"tableView"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"mapView"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"spaces"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"first"},"value":{"kind":"Variable","name":{"kind":"Name","value":"first"}}},{"kind":"Argument","name":{"kind":"Name","value":"last"},"value":{"kind":"Variable","name":{"kind":"Name","value":"last"}}},{"kind":"Argument","name":{"kind":"Name","value":"after"},"value":{"kind":"Variable","name":{"kind":"Name","value":"after"}}},{"kind":"Argument","name":{"kind":"Name","value":"before"},"value":{"kind":"Variable","name":{"kind":"Name","value":"before"}}},{"kind":"Argument","name":{"kind":"Name","value":"order"},"value":{"kind":"Variable","name":{"kind":"Name","value":"order"}}},{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"Variable","name":{"kind":"Name","value":"where"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DiscoverSpaceCard_SpaceFragment"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"gridView"}}}]}]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DiscoverTable_SpaceFragment"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"tableView"}}}]}]},{"kind":"FragmentSpread","name":{"kind":"Name","value":"DiscoverMap_SpaceFragment"},"directives":[{"kind":"Directive","name":{"kind":"Name","value":"include"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"if"},"value":{"kind":"Variable","name":{"kind":"Name","value":"mapView"}}}]}]}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"hasPreviousPage"}},{"kind":"Field","name":{"kind":"Name","value":"startCursor"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DiscoverSpaceCard_SpaceFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Space"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"description"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"images"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"pricePerDay"}},{"kind":"Field","name":{"kind":"Name","value":"averageRating"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DiscoverTable_SpaceFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Space"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"images"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"pricePerDay"}},{"kind":"Field","name":{"kind":"Name","value":"averageRating"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"DiscoverMap_SpaceFragment"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Space"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"address"}},{"kind":"Field","name":{"kind":"Name","value":"city"}},{"kind":"Field","name":{"kind":"Name","value":"latitude"}},{"kind":"Field","name":{"kind":"Name","value":"longitude"}},{"kind":"Field","name":{"kind":"Name","value":"pricePerDay"}},{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"images"}}]}}]} as unknown as DocumentNode<DiscoverSpacesQuery, DiscoverSpacesQueryVariables>;
