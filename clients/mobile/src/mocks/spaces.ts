...
export const mockSpaces: Space[] = [
  {
    ...
    type: 'window',
    description: 'Prime storefront window in busy downtown area. High foot traffic from morning commuters and lunch crowds.',
  ...
  },
  {
    ...
    type: 'poster',
    description: 'Large poster board at gym entrance. Perfect for fitness, health, and lifestyle brands.',
  ...
  },
  {
    ...
    type: 'digital_screen',
    description: '55" digital display in upscale restaurant waiting area. Great for food, beverage, and lifestyle ads.',
  ...
  },
  {
    ...
    type: 'window',
    description: 'Charming bookstore window display. Ideal for literary, educational, and artistic campaigns.',
  ...
  },
  {
    ...
    type: 'vehicle',
    description: 'Mobile advertising on popular food truck. Travels to different locations and events.',
