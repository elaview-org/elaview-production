    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-4">
      <div className="w-full max-w-md rounded-lg border border-slate-800 bg-slate-900 p-6">
        ...
        <p className="mb-4 text-sm text-slate-300">
          This will send ${Number(totalAmount).toFixed(2)} to the space owner
          and mark the dispute as resolved in favor of the owner.
        </p>
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full rounded-lg border border-slate-700 bg-slate-800 px-3 py-2 text-white placeholder:text-slate-500 focus:ring-2 focus:ring-green-500"
            placeholder="Explain why this installation was approved..."
          />
        </div>
