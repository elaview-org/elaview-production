...
export type OverviewTopSpaces_QueryFragmentFragment = { mySpaces: { __typename: 'MySpacesConnection', nodes: Array<(
      { __typename: 'Space' }
      & { ' $fragmentRefs'?: { 'OverviewTopSpacesSpaceCard_SpaceFragmentFragment': OverviewTopSpacesSpaceCard_SpaceFragmentFragment } }
    )> | null } | null } & { ' $fragmentName'?: 'OverviewTopSpaces_QueryFragmentFragment' };
