...
public sealed class BookingMutationsTests(IntegrationTestFixture fixture) : IntegrationTestBase(fixture) {
    [Fact]
    ...
    public async Task ApproveBooking_AsOwner_ApprovesBooking() {
        ...
        var response = await Client.MutateAsync<ApproveBookingResponse>("""
            ...
            """,
            new { input = new { id = booking.Id, ownerNotes = "Looking forward to working with you" } });
