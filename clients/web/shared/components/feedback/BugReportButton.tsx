...
export function BugReportModal({ isOpen, onClose }: BugReportModalProps) {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append("upload_preset", process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET || "elaview_bug_reports");
  ...
  return (
    <>
      ...
      <div
        ...
        onClick={() => !submitBug.isPending && !showSuccess && onClose()}
      />
              ...
              <div className="flex items-start justify-between p-6 border-b border-slate-800">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Help us improve Elaview</p>
                  </div>
                </div>
                <button
                  type="button"
                  onClick={onClose}
                  disabled={submitBug.isPending}
...
3. See error..."
                  ...
                  />
                  <p className="text-xs text-slate-500 text-right">
                    {description.length}/5000 characters • Be as detailed as possible
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    disabled={uploadedImages.length >= 5 || isUploading || submitBug.isPending}
                    className="hidden"
                  />
                  ...
                  {uploadedImages.length > 0 && (
                    <div className="grid grid-cols-2 gap-3">
                      {uploadedImages.map((image, index) => (
                        <div key={index} className="relative group aspect-video bg-slate-800 rounded-lg overflow-hidden border border-slate-700">
              ...
              <div className="flex items-center justify-end gap-3 p-6 border-t border-slate-800">
                ...
                <Button
                  type="submit"
                  disabled={submitBug.isPending || !title.trim() || !description.trim()}
