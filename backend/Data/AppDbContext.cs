...
public sealed class AppDbContext(DbContextOptions<AppDbContext> options)
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder) {
        ...
        new AdvertiserProfileConfig().Configure(modelBuilder.Entity<AdvertiserProfile>());
        new SpaceOwnerProfileConfig().Configure(modelBuilder.Entity<SpaceOwnerProfile>());
        ...
        new BookingDisputeConfig().Configure(modelBuilder.Entity<BookingDispute>());
        ...
        new StripeWebhookEventConfig().Configure(modelBuilder.Entity<StripeWebhookEvent>());

        new ConversationConfig().Configure(modelBuilder.Entity<Conversation>());
        new ConversationParticipantConfig().Configure(modelBuilder.Entity<ConversationParticipant>());
        new MessageConfig().Configure(modelBuilder.Entity<Message>());
        new NotificationConfig().Configure(modelBuilder.Entity<Notification>());
        new NotificationPreferenceConfig().Configure(modelBuilder.Entity<NotificationPreference>());
    }
}