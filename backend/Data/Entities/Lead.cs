...
public sealed class Lead {
    ...
    [MaxLength(50)] public string? ConvertedUserId { get; init; }
    public int SpacesListed { get; set; }
    public DateTime? FirstBookingDate { get; set; }
    public decimal TotalRevenue { get; set; }
    [MaxLength(255)] public string? ConversionSource { get; init; }
    public bool TestimonialGiven { get; set; }
    public bool WillingToRefer { get; set; }
    [MaxLength(500)] public string? ReferralNotes { get; init; }
    [MaxLength(500)] public string? Notes { get; init; }
    public DateTime CreatedAt { get; init; }
    public DateTime UpdatedAt { get; set; }
    public ICollection<OutreachLog> Outreach { get; init; } = new List<OutreachLog>();
}